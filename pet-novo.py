...
elif portePet == 3: print(input(f"obrigado caro cliente, a idade humana do {nomePet} é igual a {idadePet*7} e nos últimos 12 meses ele nos visitou {qtdBanho} e o lucro foi de {qtdBanho*(50-5)}."))
